...
function biddut_header_lang_defualt()
{
    ...
    if ($biddut_header_lang) : ?>
        ...
        <span class="tp-header-lang-selected-lang tp-lang-toggle" id="tp-header-lang-toggle"><?php print esc_html__('English', 'biddut'); ?></span>
...
?>
    ...
    <?php if (!empty($biddut_topbar_instagram_url)) : ?>
        <a class="icon linkedin" href="<?php echo esc_url($biddut_topbar_instagram_url) ?>"><i class="fa-brands fa-instagram"></i></a>
    <?php endif; ?>

    <?php if (!empty($biddut_topbar_linkedin_url)) : ?>
        <a class="icon linkedin" href="<?php echo esc_url($biddut_topbar_linkedin_url) ?>"><i class="fab fa-linkedin"></i></a>
    <?php endif; ?>
